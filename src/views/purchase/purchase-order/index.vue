    ...
    <el-row :gutter="24">
      ...
      >
        ...
        <el-table-column
          ...
          prop="supplierName"
        />
        <el-table-column label="采购数量" sortable align="center" prop="qty" />
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="采购数量" prop="qty">
              <el-input-number
                v-model="form.qty"
...
import {
  ...
  exportPurchaseOrder,
  changeStatus,
} from "@/api/purchase/purchase-order/purchaseOrder.js";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        qty: [{ required: true, message: "采购数量不能为空", trigger: "blur" }],
      },
    };
  },
  created() {
  ...
  methods: {
    ...
    getList() {
      ...
      listPurchaseOrder(
        ...
        this.purchaseOrderList = response.result.items;
